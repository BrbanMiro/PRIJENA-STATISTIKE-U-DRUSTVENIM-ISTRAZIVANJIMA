...
- Predavanje se održava ponedjeljkom od XX do XX u a seminar odmah iza predavanja od XX do XX u dvorani XX. 
- Tijekom nastave, molim studente da ne koriste mobitele i ne izlaze iz dvorane.


## CILJEVI KOLEGIJA

1. Upoznati vas sa osnovama programskog sučelja **R**.
...
4. Upoznati vas sa važnostima, korisnostima i znanstvenom relevantnosti domaćih i stranih sekundarnih izvora podataka (npr. Iz DZS, HGK, EUROSTAT i sl.)
...
- Studentima se omogućuje da polože kolegij preko dva kolokvija. 
...
- predavanja
- materijali koji će biti distribuirani u toku kolegija
